...
//  public synchronized void drawT(final Canvas canvas, List<Classifier.Recognition> results) {
...
//  }
  ...
  public synchronized void draw(final Canvas canvas) {
    ...
    frameToCanvasMatrix = ImageUtils.getTransformationMatrix(
            ...
            (int) (multiplier * (rotated ? frameHeight : frameWidth)), (int) (multiplier * (rotated ? frameWidth : frameHeight)),
