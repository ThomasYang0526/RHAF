...
public class DetectorActivityYoloV4TinyQuantized extends CameraActivity implements ImageReader.OnImageAvailableListener {
...
//                    .setOutputLayers("030_convolutional", "037_convolutional")
                    ...
                    .setModel(new File(mFile_path + "/DCIM/100MEDIA/test3_quantized.dlc"));
